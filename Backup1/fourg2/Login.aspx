        ...
        <div id="paginacanvas">
            <div class="loginwrapper">
                ...
                <fieldset>
                    ...
                    <div class="input-group margin-bottom-sm">
                        ...
                        <div class="validadorlaterallogin">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Informe seu Email*"
                    ...
                    <div class="validadorlaterallogin">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Informe sua Senha*"
                ...
                <div class="botaolembraresquece" style="padding-left: 11px;">
                    ...
                    <div class="lembraresquece">
                        ...
                        <span class="separador">.</span> <a href="#">Esqueceu sua senha?</a>
                    </div>
                </div>
                </form>
            </div>
            <div class="footerlogin">
                <p class="linkparacadastrar">
                    Não tem conta ainda? <a href="#">Cadastre-se agora.</a>
                </p>
                <p class="linkparaajuda">
                    Não sabe como funciona? Nós te ajudamos. <a href="#">Suporte.</a>
                </p>
            </div>
        </div>
    </div>
