                ...
                <table id="cadadmin" class="table table-hover" style="border: 0; margin: 0 auto; width: 650px; text-align: center;">
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1"  runat="server" ErrorMessage="*" ControlToValidate="txtnomeadm"></asp:RequiredFieldValidator></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="2">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="txtemailadm"></asp:RequiredFieldValidator></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="2">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3"  runat="server" ErrorMessage="*" ControlToValidate="txtsenhaadm"></asp:RequiredFieldValidator></td>
                        <td></td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style2" colspan="2">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ControlToValidate="txtconfsenhaadm"></asp:RequiredFieldValidator></td>
                           <td><asp:CompareValidator ID="CompareValidator1" runat="server" class="validadores" ErrorMessage="Senhas divergentes" ValueToCompare="txtsenhaadm" ControlToValidate="txtconfsenhaadm"></asp:CompareValidator> </td>
                    </tr>
                    <tr>
