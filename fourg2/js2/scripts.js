$(function () {
    ...
    $("#vDetalhes").click(function () {
        $(".tabelausuarios").fadeOut(900, function () {
            $(".detalhes").slideDown(900, function () {
                $("#fechar").fadeIn();
            });
        });
    });
    ...
    $("#fecharec").click(function () {
        $("#fecharec").fadeOut(900, function () {
            $("#trocadesenha").slideUp(900, function () {
                $("#tabelamc").fadeIn();
            });
        });
    });
    $(".excconta").click(function () {
        $("#tabelamc").fadeOut(900, function () {
            $("#excluiconta").slideDown(900, function () {
                $("#fecharec").fadeIn();
            });
        });
    });
